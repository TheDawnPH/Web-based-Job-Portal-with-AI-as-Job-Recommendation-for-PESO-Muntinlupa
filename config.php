...
if ($conn === false) {
    ...
    $user = "CREATE TABLE IF NOT EXISTS users (
        ...
        zip_code INT(4),
        region VARCHAR(255),
        latest_school_name VARCHAR(255),
        latest_school_year_begin INT(4),
        latest_school_year_end INT(4),
        technicalschool_name VARCHAR(255),
        4ps_member INT(1) DEFAULT 0,
        pwd_member INT(1) DEFAULT 0,
        disablity_type VARCHAR(255),
        skills TEXT,
        work_experience TEXT,
        ofw INT(1) DEFAULT 0,
        ofw_country VARCHAR(255),
        former_ofw INT(1) DEFAULT 0,
        last_ofw_country VARCHAR(255),
        last_ofw_year INT(4),
    ...
    $company_documents = "CREATE TABLE IF NOT EXISTS company_documents (
        ...
        trade_name text,
        tin_number text,
        pjn_accredited int(1) DEFAULT 0,
        employment_type text,
        employment_size text,
